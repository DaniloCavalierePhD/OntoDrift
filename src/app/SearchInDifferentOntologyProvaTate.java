 ...
 * @author giuseppe
 */
public class SearchInDifferentOntologyProvaTate {
    ...
    SearchInDifferentOntologyProvaTate(ArrayList<String> ontologiesToLoad,String nameToAnalyze,boolean dynamic) {
