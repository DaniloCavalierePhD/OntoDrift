 ...
 * @author giuseppe
 */
public class SingleConceptSelectionJFrame extends javax.swing.JFrame {
    public ArrayList<String> ontologiesToAnalyze;
    public String nameToAnalyze;
    /**
     * Creates new form NewJFrame1
     */
    public SingleConceptSelectionJFrame() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String [] ontoPaths ={pdf2.toString()+"/DBpediaVersions/dbpedia_3.7.owl", pdf2.toString()+"/DBpediaVersions/dbpedia_3.8.owl", pdf2.toString()+"/DBpediaVersions/dbpedia_3.9.owl",
                pdf2.toString()+"/DBpediaVersions/dbpedia_2015-04.owl", pdf2.toString()+"/DBpediaVersions/dbpedia_2015-10.owl", pdf2.toString()+"/DBpediaVersions/dbpedia_2016-04.owl", pdf2.toString()+"/DBpediaVersions/dbpedia_2016-10.owl"};
        ...
        try {
            ...
            Logger.getLogger(SingleConceptSelectionJFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(result == JOptionPane.NO_OPTION) {           
            ...
            SearchInDifferentOntology search=new SearchInDifferentOntology(ontologiesToAnalyze,nameToAnalyze,dynamic);
            try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SingleConceptSelectionJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SingleConceptSelectionJFrame().setVisible(true);
            }
        });
    }
